...
set_property PACKAGE_PIN U2 [get_ports {sw_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_out[0]}]
set_property PACKAGE_PIN U4 [get_ports {sw_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_out[1]}]
set_property PACKAGE_PIN V4 [get_ports {sw_out[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_out[2]}]
set_property PACKAGE_PIN W4 [get_ports {sw_out[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sw_out[3]}]
